...
- Tuỳ vô cửa hàng mà icon bên phải tên phòng gym sẽ hiển thị khác nhau
  - Phòng gym hiện tại　![nf](image/jp/mb/103gyms-page/current-shop-icon.png)
  - Phòng gym yêu thích　![nf](image/jp/mb/103gyms-page/current-shop-icon.png)
...
![nf](image/jp/mb/103gyms-page/current-shop.png)
    ...
    - Nút `​​店舗詳細ページ`ボタン：tap vào sẽ qua màn hình タップしたら、**Gym detail**
...
- Tìm phòng gym trên map và khi tap vào cửa hàng nào thì sẽ hiển thị popup chi tiết cửa hàng đó. Ở đây sẽ có 2 caseマップに店舗を探して、店舗をタップしたら、店舗詳細のポップアップが表示される。ここに２つのケースがあります。
...
- Gym information: giống như màn hình **Gym detail**
- Nút `​​店舗詳細`: khi tap vào nút này thì sẽ qua màn hình **Gym detail_2**
- Nút `お気に入りに登録`: tap vào sẽ thêm gym này vô danh sách yêu thích. Sau khi thêm thành công thì hiển thị popup đã thêm thành công.ボタン：タップしたら、お気に入りに店舗を登録する。登録できたら、登録済みポップアップが表示される。
