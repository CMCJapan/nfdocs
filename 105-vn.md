...
![nf](image/jp/mb/102mypage/Home.png)
...
- Case １- API data
    ...
    - `0月0日` : mm月dd日　ngày bắt đầu sử dụng dịch vụ sau khi đăng kí
...
- Sai format：　`パスワードには必ずローマ字で8-16文字以内で（大文字＋小文字＋数字）を入力してください。例：Pocket1234`
...
- Trường hợp chỉnh sửa thì filled hết các input của thẻ mà user chọn vào

##### 登録 `Button`

- Tap nút này sẽ thêm mới/ cập nhật thẻ và redirect qua màn hinh **Change credit card** 
